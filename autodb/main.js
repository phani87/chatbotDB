...
//oci.database.autonomousDataWarehouse.list( ath.authorization, compartmentId, function(data){console.log(data);});
...
oci.database.autonomousDataWarehouse.list( ath.authorization, {compartmentId: ath.compOCID }, function(data){console.log(data);} );
