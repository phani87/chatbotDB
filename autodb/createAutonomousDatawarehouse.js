...
//'WElCome123_34#', '1', '1',
function createADW(dbdisplayname, dbname, dbpasswd, dbocpus, dbstorage, callback) {
    console.log('Creating ADW');
...
//createADW('killerADW', 'killerADW','WElcome12_34#', '1', '1', function (response){console.log(response)});
